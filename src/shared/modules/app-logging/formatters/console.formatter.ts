...
${FormatUtils.colorize('║', Colors.fgBrightBlue, showColor)} ${FormatUtils.colorize('USER ROLES:', Colors.fgBrightYellow, showColor)} ${FormatUtils.colorize(roles, Colors.fgBrightCyan, showColor)}
