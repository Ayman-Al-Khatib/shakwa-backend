...
${FormatUtils.colorize('║', Colors.fgBrightBlue, showColor)} ${FormatUtils.colorize('TIME:', Colors.fgBrightYellow, showColor)} ${FormatUtils.colorize(time, Colors.fgBrightGreen, showColor)}
${FormatUtils.colorize('║', Colors.fgBrightBlue, showColor)} ${FormatUtils.colorize('RESPONSE TIME:', Colors.fgBrightYellow, showColor)} ${FormatUtils.colorize(responseTime, Colors.fgBrightGreen, showColor)}
